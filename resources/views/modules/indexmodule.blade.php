     ...
     $(this).parents("tr").find("td:nth-child(3),td:nth-child(4),td:nth-child(5),td:nth-child(6),td:nth-child(8)").each(function(){
         if(count==2){
            ...
            $(this).html(res);
             ...
             $(this).html('<form method="POST">@csrf<select name="inp'+count+'"><option value="' + $(this).text() + '" selected >' + $(this).text() + '</option><option value="started">Started</option><option value="working">working</option><option value="completed">Completed</option></select></form>');
        }else{
